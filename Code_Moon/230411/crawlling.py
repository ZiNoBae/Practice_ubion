...
# 절대경로 가져와서 \ 역슬래쉬는 하나 더 입력해줘야 / 
path = 'C:\\Users\\zino0\\Documents\\GitHub\\Practice_ubion\\Code_Moon\\chromedriver.exe'
...
df.to_csv(f'C:\\Users\\zino0\\Documents\\GitHub\\Practice_ubion\\Code_Moon\\230411\\test_0411({now}).csv')